...
def modify(answer_id):
    ...
    if request.method == "POST":
        ...
        if form.validate_on_submit():
            ...
            db.session.commit()
            # return redirect(url_for('question.detail', question_id=answer.question.id))
            return redirect('{}#answer_{}'.format(url_for('question.detail',question_id=answer.question_id),answer_id))
    else:
...
def vote(answer_id):
    ...
    return redirect('{}#answer_{}'.format(url_for('question.detail',question=answer_id),answer_id))
